...
from .window_lib import bl_ui_label
from .window_lib import bl_ui_button
from .window_lib import bl_ui_checkbox
from .window_lib import bl_ui_slider
from .window_lib import bl_ui_up_down
from .window_lib import bl_ui_drag_panel
from .window_lib import bl_ui_draw_op

#from bl_ui_draw_op import *
BL_UI_OT_draw_operator = bl_ui_draw_op.BL_UI_OT_draw_operator
BL_UI_Drag_Panel = bl_ui_drag_panel.BL_UI_Drag_Panel
BL_UI_Label = bl_ui_label.BL_UI_Label
BL_UI_Slider = bl_ui_slider.BL_UI_Slider
BL_UI_Button = bl_ui_button.BL_UI_Button
BL_UI_Up_Down = bl_ui_up_down.BL_UI_Up_Down
BL_UI_Checkbox = bl_ui_checkbox.BL_UI_Checkbox


class BE_OT_Draw_Operator(BL_UI_OT_draw_operator):

    bl_idname = "purp.tutorialwindow"
    bl_label = "Starts the tutorial"
